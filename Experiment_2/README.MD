...
### SELECTING DATA
![Selecting Data from EMPLOYEE table](screenshots/s1.png)
### DML Operations

![DML Operations using DESC](screenshots/s2.png)

### Select Output of MIN query
![Select Output of MIN query](screenshots/s3.png)

### SELECT Output of AVG query
![Select Output of AVG query](screenshots/s4.png)

### Query to show having by and grouping
![Query to show havingby and grouping](screenshots/s5.png)
g)
